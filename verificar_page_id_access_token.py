...
# publicaciones.json está en el mismo directorio que publicar.py
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
JSON_FILE = os.path.join(BASE_DIR, "publicaciones.json")
...
def comprobar_token():
    ...
    try:
        ...
        if response.status_code != 200:
            ...
            print(
                "⚠️ Facebook respondió con error "
                "al comprobar el token:"
            )
...
def comprobar_pagina():
    ...
    try:
        ...
        print(
            f"HTTP Página: {response.status_code}"
        )
        ...
        if str(data.get("id")) != str(PAGE_ID):
            ...
            print(
                "❌ El PAGE_ID no coincide "
                "con la Página del token."
            )
        ...
        if data.get("can_post") is not True:
            ...
            print(
                "⚠️ Facebook no indica can_post=true."
            )
...
# ============================================================
# OBTENER PUBLICACIONES.JSON LOCAL
# ============================================================

def obtener_publicaciones():

    print("\n📄 Leyendo publicaciones.json...")
    ...
    try:
        ...
        if len(publicaciones) == 0:
            ...
            print(
                "ℹ️ No hay publicaciones pendientes."
            )
        ...
        print(
            f"❌ Error leyendo publicaciones.json: {e}"
        )
...
# ============================================================
# GUARDAR PUBLICACIONES.JSON
# ============================================================

def guardar_publicaciones(publicaciones):

    print("\n💾 Guardando publicaciones.json...")
    ...
    try:
        ...
        print(
            "✅ publicaciones.json actualizado."
        )
        ...
        print(
            f"❌ Error guardando publicaciones.json: "
            f"{e}"
        )
...
def publicar_en_feed(
    ...
    print(
        "PASO 2: Publicando imagen + texto en el Feed..."
    )
    ...
    # IMPORTANTE:
    # Facebook recibe attached_media como
    # una cadena JSON.
...
def main():
    ...
    if not token_valido:
        ...
        print(
            "No continuamos para evitar publicar "
    ...
    try:
        ...
        if (
            ruta_imagen
            and os.path.exists(ruta_imagen)
        ):
